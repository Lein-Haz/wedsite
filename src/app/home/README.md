...
- `home.scss` - module-specific styles; this file is auto-magically processed
                into a css file, then either added to the index(build) or concatenated(compile) in a main css
...
And of course we define a min-safe controller for our route, which is referenced through the config block.  Though in this case it does
nothing.
